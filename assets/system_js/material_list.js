...
function paging(end, start, total){
  ...
  if (total_paging_cnt == 0 || total_paging_cnt == 1 || pre_no == 0)
  {
    ...
    text +='<a class="page-link" href="./material_list.html?page_no='+pre_no+'&search_text='+$("#search_text").val()+'&type='+$("#type_id").val()+'" aria-label="Previous">';
  ...
  for( var k = paging_init_num; k <= paging_end_num; k++){
    ...
    {
      text +='<li class="page-item active"><a class="page-link" href="./material_list.html?page_no='+k+'&search_text='+$("#search_text").val()+'&type='+$("#type_id").val()+'">'+k+'</a></li>';
    }else{
      text +='<li class="page-item"><a class="page-link" href="./material_list.html?page_no='+k+'&search_text='+$("#search_text").val()+'&type='+$("#type_id").val()+'">'+k+'</a></li>';
    }
  }
  if (total_paging_cnt == 0 || total_paging_cnt == 1 || next_no > total_paging_cnt)
  {
    ...
    text +='<li class="page-item">';
    text +='  <a class="page-link" href="./material_list.html?page_no='+next_no+'&search_text='+$("#search_text").val()+'&type='+$("#type_id").val()+'" aria-label="Next">';
...
$("#search_btn").on("click", function(){
    $.ajax({
      ...
      if(data.status == 200){
        location.href="../system_management/material_list.html?search_text="+$("#search_text").val()+"&type="+$("#type_id").val();
      }else{
        alert(data.message);
      }
    })
