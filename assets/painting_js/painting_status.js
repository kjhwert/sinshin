...
function paging(end, start, total){
 ...
 $("#stock_qty").on("click", function(){
   ...
   location.href="../product_history/painting_warehousing.html?start_date="+param_start_date+"&end_date="+param_end_date;
 });
 ...
 $("#start_qty").on("click", function(){
   ...
   location.href="../product_history/painting_start.html?start_date="+param_start_date+"&end_date="+param_end_date;
 });
 ...
 $("#complete_qty").on("click", function(){
   ...
   location.href="../product_history/painting_end.html?start_date="+param_start_date+"&end_date="+param_end_date;
 });
 ...
 $("#defect_qty").on("click", function(){
   ...
   location.href="../product_history/painting_defect.html?start_date="+param_start_date+"&end_date="+param_end_date;
 });
 ...
 $("#release_qty").on("click", function(){
   ...
   location.href="../product_history/painting_release.html?start_date="+param_start_date+"&end_date="+param_end_date;
 });
