...
function defect_list (page_no, per_page) {
    $.ajax({
        ...
        for (i in results) {
            ...
            text += '    <td>'+comma(results[i].input)+'</td>'
            text += '    <td>'+comma(results[i].output)+'</td>'
            text += '    <td>'+comma(results[i].loss)+'</td>'
            text += '    <td>'+comma(results[i].defect)+'</td>'
            text += '    <td>'+results[i].output_percent+'%</td>'
            text += '    <td>'+results[i].loss_percent+'%</td>'
            text += '    <td>'+results[i].defect_percent+'%</td>'
            text += '    <td>'
